...
CustomSkinnedButton::CustomSkinnedButton(HINSTANCE hInstance, WORD wBitmapResource_ButtonOut, WORD wBitmapResource_ButtonOver, WORD wBitmapResource_ButtonIn, COLORREF transparencyColorKey){
    ...
    bmWidth = pButtonIn->getBitmapWidth();
...
void CustomSkinnedButton::mouseIsOut(){
    bMouseOver = false;
}

void CustomSkinnedButton::mouseLeftDown(){
    bMouseLeftButtonDown = true;
}

void CustomSkinnedButton::mouseLeftUp(){
    bMouseLeftButtonDown = false;
}

bool CustomSkinnedButton::isMouseOver(){
    return bMouseOver;
}

bool CustomSkinnedButton::isMouseLeftButtonDown(){
    return bMouseLeftButtonDown;
}

LONG CustomSkinnedButton::getBitmapWidth(){
    return bmWidth;
}

LONG CustomSkinnedButton::getBitmapHeight(){
    return bmHeight;
}

WORD CustomSkinnedButton::getbuttonState(){
    if(bMouseLeftButtonDown == true && bMouseOver == true){ // Check to see if the mouse is hovering over the button AND that the left mouse button is held down
        return BUTTONSTATE_IN;
    }
    else if(bMouseOver == true){                // Check to see if the mouse is only hovering
        return BUTTONSTATE_OVER;
    }
    else{                                       // The mouse is neither hovering nor is the left button being held down
        return BUTTONSTATE_OUT;
    }
}

HBITMAP CustomSkinnedButton::getHandleButtonOutBitmap(){
    return pButtonOut->getBitmapHandle();
}

HBITMAP CustomSkinnedButton::getHandleButtonOverBitmap(){
    return pButtonOver->getBitmapHandle();
}

HBITMAP CustomSkinnedButton::getHandleButtonInBitmap(){
    return pButtonIn->getBitmapHandle();
}

HRGN CustomSkinnedButton::getHandleToVisibleRegion(){
...
void CustomSkinnedButton::SetVisibleRgnFromBitmap(HBITMAP hBmp, COLORREF color)
{
...
CustomSkinnedButton::~CustomSkinnedButton()
{
    delete pButtonOut;
    delete pButtonOver;
    delete pButtonIn;
